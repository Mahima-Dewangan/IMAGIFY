...
const Header = () => {
  ...
  return (
    ...
    animate={{opacity:1, y:0}}>
      ...
      initial={{opacity:0, y:20}}
      animate={{opacity:1, y:0}}
      transition={{delay:0.6 , duration:0.8}}>Unleash your creativuty with AI. Turn your 
        imagination into visual arts in seconds - just type, and 
     ...
     className='flex flex-wrap justify-center mt-16 gap-3 '>
        {Array(6).fill('').map((item, index)=>(
            ...
            className='rounded hover:scale-105 transition-all duartion-300 cursor-pointer max-sm:w-10' src={ index % 2 ===0 ? assets.sample_img_2 : assets.sample_img_1} alt="" key={index} width={70} />
        ))}
     </motion.div>
